...
class Auth extends MY_Controller {
	...
	function index()
	{
		...
		if (!$this->ion_auth->logged_in())
		{
			...
			redirect($this->lang->lang().'/auth/login', 'refresh');
		}
		elseif (!$this->ion_auth->is_admin())
		{
			//redirect them to the home page because they must be an administrator to view this
			redirect($this->config->item('base_url').$this->lang->lang(), 'refresh');
		}
		else
		{
	...
	function login()
	{
		...
		{ //check to see if the user is logging in
			...
			{ //if the login is successful
				...
				redirect($this->config->item('base_url').$this->config->item("lang"), 'refresh');
			}
			else
			{ //if the login was un-successful
				//redirect them back to the login page
				$this->session->set_flashdata('message', $this->ion_auth->errors());
				redirect($this->lang->lang().'/auth/login', 'refresh'); //use redirects instead of loading views for compatibility with MY_Controller libraries
			}
		}
		else
	...
	function logout()
	{
		...
		redirect($this->lang->lang().'/auth', 'refresh');
	}
	...
	public function user_check()
	{
		if (!$this->ion_auth->logged_in())
		{
			redirect($this->lang->lang().'/auth/login');
		}
	}
